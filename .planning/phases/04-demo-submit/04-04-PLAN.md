...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>Rendered architecture diagram from existing Mermaid source</what-built>
  <how-to-verify>
    1. Open `docs/architecture.png` in an image viewer or browser
    2. Confirm all 8 agents are visible and labeled: BookingAgent, SearchAgent, SummaryAgent, FailureDetector, TraceAnalyzer, ToolAnalyzer, DiagnosisEngine, FixGenerator
    3. Confirm data flow arrows are readable and the overall layout is clear for hackathon judges
    4. Confirm TraceStore and IndagineController/IndaginePipeline orchestration glue are also shown
  </how-to-verify>
  <resume-signal>Type "approved" if the diagram is readable and complete, or describe issues to fix</resume-signal>
</task>
...
- Human confirms visual readability
</verification>
